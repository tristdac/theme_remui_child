...
class block_myoverview_renderer extends \block_myoverview\output\renderer
{
    ...
    {
        $color = array('#f2a654','#fe6768','#57c7d4','#56c19a','#526069','#46657d','#d6494b','#3583ca','#715146','#6d45bc','#424242','#37a9b7','#178d81');
        ...
        foreach ($totalcourses as $key => $value) {
            ...
            $totalcourses[$key]->tooltipname = $totalcourses[$key]->fullnamedisplay.' - '.$totalcourses[$key]->summary;

            // set the text limit to course name value
            $totalcourses[$key]->fullnamedisplay = (strlen($totalcourses[$key]->fullnamedisplay) > 75) ? substr($totalcourses[$key]->fullnamedisplay, 0, 75).'...' : $totalcourses[$key]->fullnamedisplay;
